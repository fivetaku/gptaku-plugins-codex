# Disclaimer & Acceptable Use — insane-design

`insane-design` is part of the [gptaku-plugins-codex](https://github.com/fivetaku/gptaku-plugins-codex)
...
`insane-design` is a general-purpose developer tool. Like most general-purpose tools, it
