# Disclaimer & Acceptable Use — kkirikkiri

`kkirikkiri` is part of the [gptaku-plugins-codex](https://github.com/fivetaku/gptaku-plugins-codex)
...
`kkirikkiri` is a general-purpose developer tool. Like most general-purpose tools, it
