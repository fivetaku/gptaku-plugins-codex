# Disclaimer & Acceptable Use — dd

`dd` is part of the [gptaku-plugins-codex](https://github.com/fivetaku/gptaku-plugins-codex)
...
`dd` is a general-purpose developer tool. Like most general-purpose tools, it
