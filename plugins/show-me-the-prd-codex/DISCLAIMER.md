# Disclaimer & Acceptable Use — show-me-the-prd

`show-me-the-prd` is part of the [gptaku-plugins-codex](https://github.com/fivetaku/gptaku-plugins-codex)
...
`show-me-the-prd` is a general-purpose developer tool. Like most general-purpose tools, it
